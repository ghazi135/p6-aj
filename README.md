...
- APP_TYPE: `springboot`
- (Optional, for SonarQube/SonarCloud) SONAR_PROJECT_KEY, SONAR_ORGANIZATION, SONAR_HOST_URL — see [SONARQUBE.md](SONARQUBE.md).

### Repository Secrets

- DOCKERHUB_USERNAME: Docker Hub username
- DOCKERHUB_TOKEN: Docker Hub access token
- (Optional) SONAR_TOKEN: token for SonarCloud or SonarQube — see [SONARQUBE.md](SONARQUBE.md).
